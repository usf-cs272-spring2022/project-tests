...
public class Project4Test extends ProjectTests {
	...
	public class A_IndexTests {
		...
		@ParameterizedTest
		@ValueSource(strings = {
				"https://www.cs.usfca.edu/~cs272/simple/hello.html",
				"https://www.cs.usfca.edu/~cs272/simple/mixed_case.htm",
				"https://www.cs.usfca.edu/~cs272/simple/position.html",
				"https://www.cs.usfca.edu/~cs272/simple/symbols.html",
				"https://www.cs.usfca.edu/~cs272/birds/yellowthroat.html" })
		...
		public void testSimple() {
			String seed = "https://www.cs.usfca.edu/~cs272/simple/";
		...
		@ParameterizedTest
		@ValueSource(strings = {
				"https://www.cs.usfca.edu/~cs272/rfcs/rfc475.html",
				"https://www.cs.usfca.edu/~cs272/rfcs/rfc3629.html",
				"https://www.cs.usfca.edu/~cs272/rfcs/rfc5646.html",
				"https://www.cs.usfca.edu/~cs272/rfcs/rfc6805.html",
				"https://www.cs.usfca.edu/~cs272/rfcs/rfc6838.html",
				"https://www.cs.usfca.edu/~cs272/rfcs/rfc7231.html" })
		...
		@ParameterizedTest
		@ValueSource(strings = {
				"https://www.cs.usfca.edu/~cs272/guten/37134-h/37134-h.htm",
				"https://www.cs.usfca.edu/~cs272/guten/22577-h/22577-h.htm",
				"https://www.cs.usfca.edu/~cs272/guten/1661-h/1661-h.htm",
				"https://www.cs.usfca.edu/~cs272/guten/1322-h/1322-h.htm",
				"https://www.cs.usfca.edu/~cs272/guten/2701-h/2701-h.htm",
				"https://www.cs.usfca.edu/~cs272/guten/50468-h/50468-h.htm",
				"https://www.cs.usfca.edu/~cs272/guten/1400-h/1400-h.htm" })
		...
		public void testGuten() {
			String seed = "https://www.cs.usfca.edu/~cs272/guten/";
		...
		@ParameterizedTest
		@ValueSource(strings = {
				"https://www.cs.usfca.edu/~cs272/javadoc/api/java.base/java/util/AbstractCollection.html",
				"https://www.cs.usfca.edu/~cs272/javadoc/api/java.compiler/javax/lang/model/SourceVersion.html",
				"https://www.cs.usfca.edu/~cs272/javadoc/api/java.desktop/java/awt/desktop/AboutHandler.html",
				"https://www.cs.usfca.edu/~cs272/javadoc/api/java.prefs/java/util/prefs/AbstractPreferences.html",
				"https://www.cs.usfca.edu/~cs272/javadoc/api/overview-tree.html" })
		...
		public void testJava() {
			String seed = "https://www.cs.usfca.edu/~cs272/javadoc/api/allclasses-index.html";
	...
	public class B_CountTest {
		...
		@Order(1)
		public void testSimple() {
			String link = "https://www.cs.usfca.edu/~cs272/simple/";
			testCounts(link, 10);
		}
		...
		@Order(2)
		public void testBirds() {
			String link = "https://www.cs.usfca.edu/~cs272/birds/birds.html";
			testCounts(link, 50);
		}
		...
		@Order(3)
		public void testRecurse() {
			String link = "https://www.cs.usfca.edu/~cs272/recurse/link01.html";
			testCounts(link, 100);
		}
		...
		@Order(4)
		public void testRedirect() {
			String link = "https://www.cs.usfca.edu/~cs272/redirect/index.html";
			testCounts(link, 10);
		}
		...
		@Tag("test4")
		public void testLocal() {
			String link = "https://www.cs.usfca.edu/~cs272/local.html";
			testCounts(link, 200);
		}
		...
		@Tag("test4")
		public void testRFCs() {
			String link = "https://www.cs.usfca.edu/~cs272/rfcs/";
			testCounts(link, 7);
		}
		...
		public void testGutenberg() {
			String link = "https://www.cs.usfca.edu/~cs272/guten/";
			testCounts(link, 8);
		}
		...
		@Order(8)
		public void testJava() {
			String link = "https://www.cs.usfca.edu/~cs272/javadoc/api/allclasses-index.html";
			testCounts(link, 50);
		}
	}
	...
	public class D_RuntimeTest {
		...
		public void testIndexMultithreaded() {
			...
			String[] args1 = { HTML_FLAG, link, MAX_FLAG, Integer.toString(limit),
					THREADS_FLAG, String.valueOf(2) };

			String[] args2 = { HTML_FLAG, link, MAX_FLAG, Integer.toString(limit),
					THREADS_FLAG, String.valueOf(BENCH_THREADS) };

			System.out.println();
			System.out.printf("### Testing Build 2 vs %d Workers...%n",
					BENCH_THREADS);
			...
			assertTimeoutPreemptively(LONG_TIMEOUT, () -> {
				double result = Project3bTest.compare("bench-crawl-multi", "2 Workers", args1,
						String.valueOf(BENCH_THREADS) + " Workers", args2, warmRuns, timeRuns);

				assertTrue(result >= 1.4, () -> String.format(
	...
	public static void testIndex(String link, String subdir, int limit) {
		...
		String[] args = { HTML_FLAG, link, MAX_FLAG, Integer.toString(limit),
	 ...
	 */
	public static void testSearch(String link, int limit, boolean exact,
			String query) {
		String name = getTestName(link);
		...
		String[] args = { HTML_FLAG, link, MAX_FLAG, Integer.toString(limit),
				QUERY_FLAG, QUERY_PATH.resolve(query).toString(), RESULTS_FLAG,
				actual.normalize().toString(), THREADS_FLAG,
				Integer.toString(THREADS_DEFAULT), exact ? EXACT_FLAG : "" };
	...
	public static String getTestName(String link) {
		...
		if (matcher.matches()) {
			...
			// special cases
			if (file == null || file.isBlank() || file.endsWith("index")
